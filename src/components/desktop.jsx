...
import metamasklogo from "./images/logo/metamask-logo.png";
...
const Desktop = ({ open, handleClose }) => {
      ...
      >
        <Box sx={style}>
          ...
          >
            ...
            >
              <img src={metamasklogo} style={{ width: 273, height: 51 }} />
            </div>
            ...
            <div>
              ...
              {walletstatus === true ? (
                <div id="contectedextension">
                  ...
                  >
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          <stop stopColor="#FFE466"></stop>
                          <stop offset="1" stopColor="#FFAFEA"></stop>
                        </linearGradient>
                        <linearGradient
                          ...
                          gradientUnits="userSpaceOnUse"
                        >
                          <stop stopColor="#75C3FC"></stop>
                          <stop offset="0.0929" stopColor="#81C2F6"></stop>
                          <stop offset="1" stopColor="#F0B8BD"></stop>
                        </linearGradient>
                        <linearGradient
                        ...
                        >
                          <stop stopColor="#75C3FC"></stop>
                          <stop offset="1" stopColor="#75C3FC"></stop>
                        </linearGradient>
                        <linearGradient
                  ...
                  >
                    Take control of your crypto and explore the blockchain with
                    the wallet trusted by over 30 million people worldwide
                  </div>
                  <button
                    style={{
                      marginTop: "41.5px",
                  ...
                  <div style={tabStyles}>
                    <div style={flexStyles}>
                      ...
                      <div>
                        <div style={flexStylestext}>
                          <span style={{ lineHeight: 2, color: "black" }}>
                            The leading crypto wallet & gateway to blockchain
                            apps built on Ethereum Mainnet, Polygon, Optimism,
